...
<a class="btn courses-btn" href="<?php echo e(url('about')); ?>">Learn more</a>
</div>
</div>
</div>
</div>
...
<div class="img-part">
<img src="<?php echo e($a['img']); ?>" class="img-fluid" alt="<?php echo e($a['title']); ?>">
</div>
<div class="content-part">
<div class="content-text">
<h3><?php echo e($a['title']); ?></h3>
<h4 class="title"><?php echo e($a['desc']); ?></h4>
</div>
</div>
</div>
<?php
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\blueforcetest\resources\views/index.blade.php ENDPATH**/ ?>